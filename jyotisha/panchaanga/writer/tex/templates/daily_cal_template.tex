...
\small राहु॰~\textsf{#1}~~यम॰~\textsf{#2}~~गुलिक॰~\textsf{#3}\\[-0.5ex]%Rahu Yama Gulika
\scriptsize दुर्मु॰~\textsf{#4}~~अभिजित्~\textsf{#5}~~वर्ज्यम्~\textsf{#6}~~अमृत॰~\textsf{#7}%Durmuhurta Abhijit Varjyam Amrita
\end{minipage}
}
